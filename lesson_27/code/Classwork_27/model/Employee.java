...
public abstract class Employee {
    ...
    public boolean equals(Object o) {
        ...
        return id == employee.id && Double.compare(hours, employee.hours) == 0 && Objects.equals(name, employee.name) && Objects.equals(secondName, employee.secondName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, secondName, hours);
    }

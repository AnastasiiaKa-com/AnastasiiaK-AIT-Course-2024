    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            if (ch == 'y') {
                ...
                System.out.println("1-> +");// моöно взять в одинарные ковычки ("1-> + '+')
                System.out.println("2-> -");// можно взять в одинарные ковычки ("1-> + '+')
                System.out.println("3-> *");// можно взять в одинарные ковычки ("1-> + '+')
                System.out.println("4-> /");// можно взять в одинарные ковычки ("1-> + '+')
                System.out.println("5-> %");// можно взять в одинарные ковычки ("1-> + '+')
